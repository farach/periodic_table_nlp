...
index_record <- tibble(
  ...
  value = c(
    ...
    as.character(k1),
    as.character(b),
    actual_hashes$fingerprint[actual_hashes$artifact == "riverton-handbook.csv"],
