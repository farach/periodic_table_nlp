...
These tools enforce key disciplines that custom rules often miss:
- **Explicit document-time anchors**: A relative phrase like `next Friday` or `tomorrow` means nothing without a strict reference date. Production systems require you to pass the exact timestamp a document was published to anchor the calculation.
