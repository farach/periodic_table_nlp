...
- **Locale formats**: It reads the European format `1.250,50` incorrectly: it silently matches `1.250` and yields an amount of 1.25 because it expects commas as thousands separators.
