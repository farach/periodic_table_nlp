...
If human reference summaries existed, an overlap measure such as **ROUGE**
could compare selected words or word sequences with those references. ROUGE
would measure overlap, not whether the summary is complete, factual, or useful
...
- [Lin's ROUGE evaluation paper](https://aclanthology.org/W04-1013/)
